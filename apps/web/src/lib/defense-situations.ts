...
export const SITUATIONS: Partial<Record<SituationKey, SituationMap>> = {
  ...
  "010:gb_c": sit(
    CV("Cover home"),
    B("Field, look runner back, throw to 1B"),
    CV("Cover 1B"),
    CV("Cover 2B"),
    CV("Cover 3B"),
    CV("Cover 3B"),
  ...
  "010:gb_3b": sit(
    ...
    CV("Cover 2B"),
    CV("Cover 3B"),
    B("Field, tag runner or throw to 1B"),
    BU("Back up home"),
    HO("Hold"),
    HO("Hold"),
  ),
  ...
  "001:gb_c": sit(
    CV("Cover home (catcher fielding)"),
    B("Field quickly, look runner back, throw to 1B"),
    CV("Cover 1B"),
    CV("Cover 2B"),
    CV("Cover 3B"),
    CV("Cover 3B"),
  ...
  "001:gb_1b": sit(
    CV("Cover 1B"),
    CV("Cover home"),
    B("Field, look home, throw to P at 1B"),
    CV("Cover 2B"),
    CV("Cover 3B"),
    CV("Cover 3B"),
    BU("Back up home"),
  ...
  "110:gb_c": sit(
    CV("Cover home (catcher fielding)"),
    B("Field, look runners back, throw to 3B or 2B"),
    CV("Cover 1B"),
    CV("Cover 2B"),
    CV("Cover 3B"),
    CV("Cover 3B"),
  ...
  "110:gb_3b": sit(
    ...
    CV("Cover 2B"),
    CV("Cover 3B"),
    B("Field, step on 3B, throw to 1B"),
    BU("Back up home"),
    HO("Hold"),
    HO("Hold"),
  ),
  ...
  "101:gb_c": sit(
    CV("Cover home (catcher fielding)"),
    B("Field quickly, look home, throw to 1B"),
    CV("Cover 1B"),
    CV("Cover 2B"),
    CV("Cover 3B"),
    CV("Cover 3B"),
  ...
  "011:gb_ss": sit(
    ...
    CV("Cover 1B"),
    CV("Cover 2B"),
    B("Field, check runner at home, throw to 1B"),
    CV("Cover 3B"),
    BU("Back up home"),
    HO("Hold"),
    HO("Hold"),
  ...
  "111:gb_c": sit(
    CV("Cover home"),
    B("Field, step on home, throw to 1B — double play!"),
    CV("Cover 1B"),
    CV("Cover 2B"),
    CV("Cover 3B"),
    CV("Cover 3B"),
  ...
  "111:gb_1b": sit(
    CV("Cover 1B"),
    CV("Cover home (force)"),
    B("Field, throw home for force, or step on 1B"),
    CV("Cover 2B"),
    CV("Cover 3B"),
    CV("Cover 3B"),
    BU("Back up home"),
  ...
  "111:gb_2b": sit(
    BU("Back up 1B"),
    CV("Cover home"),
    CV("Cover 1B (receive throw)"),
    B("Field, step on 2B, throw to 1B — double play!"),
    CV("Cover 3B"),
    CV("Cover 3B"),
    BU("Back up home"),
    HO("Hold"),
  ...
  "111:gb_3b": sit(
    ...
    CV("Cover 2B"),
    CV("Cover 3B (backup)"),
    B("Field, step on 3B, throw to 1B — double play!"),
    BU("Back up home"),
    HO("Hold"),
    HO("Hold"),
  ),
